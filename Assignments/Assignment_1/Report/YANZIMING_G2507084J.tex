...
\begin{figure}[H]
    \centering
    \includegraphics{Images/MMD_accuracy.png}
...
\begin{figure}[H]
    \centering
    \includegraphics{Images/kNN_accuracy.png}
    \caption{Linear Reduction Performance with KNN}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics{Images/LogisticRegression_accuracy.png}
    \caption{Linear Reduction Performance with Linear\_regression}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics{Images/manifold_methods_accuracy.png}
