...
There is possible that covariance may be singular, leading no inversion. So I added the covariance with \texttt{1e-6 * np.eye(X.shape[1]) } to avoid singular condition.
